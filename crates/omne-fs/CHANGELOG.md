...
- `policy_io` now reads policy files through `omne-fs-primitives` ambient-root regular-file helpers,
  so policy loading rejects symlink/reparse-point ancestor directories instead of only protecting
  the final file open.
