# omne-archive-primitives AGENTS Map
...
- Archive responsibilities change: update `system-boundaries.md`.
- Source file responsibilities change: update `source-layout.md`.
