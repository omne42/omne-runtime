...
- target binary matching by binary name, tool name, and optional `archive_binary` hint, which may be an exact archive path or a unique archive-relative suffix
