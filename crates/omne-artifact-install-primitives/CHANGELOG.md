...
- remove the deprecated legacy constructor so archive-backed installs only expose `binary_name` plus optional exact `archive_binary_hint` at the primitive boundary
